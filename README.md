...
║   ╚═╝  ╚═╝ ╚═════╝ ╚═════╝ ╚══════╝╚══════╝╚══════╝            ║
║                                                                ║
║        > SISTEMAS · DESARROLLO · IA · CIBERSEGURIDAD <         ║
║                                                                ║
╚══════════════════════════════════════════════════════════════╝
```

**`root@huelva`** : **`~/miguel-robles`** $ `whoami`

Técnico Superior en Administración de Sistemas · Desarrollador · Huelva, ES
...
[![YouTube](https://img.shields.io/badge/▶_YOUTUBE-0e1116?style=flat-square&labelColor=0e1116&color=e5534b)](https://www.youtube.com/@robles0797)
...
```
drwxr-xr-x   PHPBERT        Detección de vulnerabilidades PHP con IA
drwxr-xr-x   JARVIS         Asistente de IA local (voz + Telegram)
drwxr-xr-x   web-clinica    Sistema de gestión médica completo
```

**`▸ PHPBERT`** — `IA · Seguridad`
Sistema híbrido que detecta vulnerabilidades en código PHP con un modelo CodeBERT afinado. **F1 0.915 · 92% de precisión.** TFG desplegado en HuggingFace Spaces con base de datos en producción.
`Python` · `CodeBERT` · `HuggingFace` · `Supabase`
...
```
   ...
   IA / ML   ▸  CodeBERT · Ollama · HuggingFace · PyTorch
   SEGURIDAD ▸  nmap · Metasploit · OSINT · análisis de vulnerabilidades
